package ch.bbw.onePass.auth;


import ch.bbw.onePass.config.JwtService;
import ch.bbw.onePass.model.UserEntity;
import ch.bbw.onePass.repository.UserRepository;
import ch.bbw.onePass.token.Token;
import ch.bbw.onePass.repository.TokenRepository;
import ch.bbw.onePass.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    var user = UserEntity.builder()
        ...
        .secretKey(passwordEncoder.encode(request.getPassword()))
